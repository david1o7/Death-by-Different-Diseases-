...
const chart_api_base_url = 'http://127.0.0.1:8082/api/measles/charts';
const data_api_url = 'http://127.0.0.1:8080/api/measles/data';
...
const Measles = () => {
  ...
  if (loading) {
    return <div className="loading">Loading Measles data...</div>;
  }
  if (error) {
  ...
  return (
    <>
      <Navbar />
      <div className="measles-dashboard">
        <h1>Measles Data Visualization Dashboard</h1>
        ...
        <div className="filters">
          ...
          <div className="filter-group">
            ...
            <input
              ...
              placeholder="Enter minimum cases"
            />
          </div>
        </div>

        {/* Measles Charts Section */}
        <section className="chart-section">
          <h2>Measles Charts</h2>
          <div className="charts-grid">
            <div className="chart-container">
              <h3>Global Measles Cases Over Time</h3>
              <img src={`${chart_api_base_url}/global_cases`} alt="Global Measles Cases" />
            </div>
            <div className="chart-container">
              <h3>Top 10 Countries by Total Measles Cases</h3>
              <img src={`${chart_api_base_url}/top_countries`} alt="Top Countries Measles Cases" />
            </div>
            <div className="chart-container">
              ...
              <img
                ...
                alt="Country Measles Profile"
                style={{ display: selectedCountry !== 'all' ? 'block' : 'none' }}
              />
              {selectedCountry === 'all' && <div style={{textAlign:'center',color:'#e67e22'}}>Select a country to view its profile chart.</div>}
            </div>
            <div className="chart-container">
              ...
              {compareCountries.length > 0 ? (
                <img src={compareUrl} alt="Compare Countries Measles" style={{marginTop: '10px'}} />
              ) : (
                <div style={{textAlign:'center',color:'#e67e22',marginTop:'10px'}}>Select countries to compare.</div>
              )}
            </div>
          </div>
        </section>
